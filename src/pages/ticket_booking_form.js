...
export const Ticketbookingform = () => {
        ...
        var options = {
            ...
            handler: function (response) {
                ...
                fire.firestore().collection("Bookings").add({
                    ...
                    history.push({ pathname: "/success", state: { profile: profile, email: email, password: password, mobile: mobile, bookingdate: bookingdate, username: username, totalceats: ceats, ceatnames: allSeatarray, name: name } })
    ...
    return (
        <div class="form-container sign-in-container" className="ticket-booking" >
                    ...
                    <center>
                        ...
                        <table id="seatsBlock" style={{ marginLeft: "15%" }}>
                            ...
                            <tr>
                                ...
                                <td rowspan="20">
                                    <div class="smallBox greenBox" style={{ width: 'max-content' }}> Selected slot</div> <br />
                                    <div class="smallBox redBox" style={{ width: 'max-content' }}> Reserved slot</div><br />
                                    <div class="smallBox emptyBox" style={{ width: 'max-content' }}> Empty slot</div><br />
                                </td>
            ...
            <br />
            <button className="pay-btn" style={{ marginLeft: "39%" }} onClick={paymentFunction}>Done</button>
        </div>
    )
}
